...
import img1 from '../../assets/img/jpg/image 2.jpg'
import img2 from '../../assets/img/jpg/image.jpg'
import img3 from '../../assets/img/jpg/app-background.jpg'
import img4 from '../../assets/img/jpg/form-background.jpg'
    ...
    <div className={c.App}>
      ...
      <main>
        <Container image={img1 + ''}>
          ...
          <Button text={'Заполните анкету'}/>
        </Container>

        <section className={`${c.start} offset maxWidth`}>
          <h2 className={c.head}>Начало работы</h2>
        ...
        <Container image={img2 + ''} dark={true} paddingTop={65} paddingBottom={82}>
          <h2 className={c.head}>Работа в удовольствие</h2>
          <ul className={c.advantages}>
            <li className={c.advantagesItem}>
              ...
              <div className={c.advantagesContent}>
                <h3 className={c.advantagesHead}>Удобный график</h3>
            ...
            <li className={c.advantagesItem}>
              ...
              <div className={c.advantagesContent}>
                <h3 className={c.advantagesHead}>Деньги - сразу</h3>
            ...
            <li className={c.advantagesItem}>
              ...
              <div className={c.advantagesContent}>
                <h3 className={c.advantagesHead}>Партнерская программа</h3>
        ...
        <section className={`${c.contacts} maxWidth offset`}>
          ...
          <div className={c.contactsContainer}>
            ...
            <div className={c.contactsRightSide}>
              ...
              <p className={c.contactInfo}><span>Офис:</span> <span className={c.contactSpan}>г.Омск, ул.Дмитриева 15/1</span></p>
            </div>
          </div>
        </section>

        <Container image={img4 + ''}>
          <h2 className={`${c.head} ${c.jobHead}`}>Работа в удовольствие</h2>
          <Form/>
        </Container>
